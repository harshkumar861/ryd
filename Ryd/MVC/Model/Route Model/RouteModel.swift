...
//
//   let routeModel = try? newJSONDecoder().decode(RouteModel.self, from: jsonData)
...
struct Leg: Codable {
    ...
    let endAddress, startAddress: String?
...
// MARK: - Step
struct Step: Codable {
    let travelMode, htmlInstructions: String?
    let startLocation: Northeast?
